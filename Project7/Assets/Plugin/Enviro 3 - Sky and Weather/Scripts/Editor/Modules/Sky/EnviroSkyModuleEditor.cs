...
namespace Enviro
{
    ...
    public class EnviroSkyModuleEditor : EnviroModuleEditor
    {
        ...
        private SerializedProperty backColorGradient0,
            backColorGradient1,
            backColorGradient2,
            backColorGradient3,
            backColorGradient4,
        ...
        private SerializedProperty mieScatteringIntensityCurve,
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EnviroManager.instance.RemoveModule(EnviroManagerBase.ModuleType.Sky); //Add Remove
            ...
            if (myTarget.showModuleInspector)
            {
                ...
                GUILayout.BeginVertical("", boxStyleModified);
                GUI.backgroundColor = Color.white;
                myTarget.showSkySunControls =
                    GUILayout.Toggle(myTarget.showSkySunControls, "Sun Controls", headerFoldout);
                ...
                GUILayout.BeginVertical("", boxStyleModified);
                GUI.backgroundColor = Color.white;
                myTarget.showSkyMoonControls =
                    GUILayout.Toggle(myTarget.showSkyMoonControls, "Moon Controls", headerFoldout);
                ...
                GUILayout.BeginVertical("", boxStyleModified);
                GUI.backgroundColor = Color.white;
                myTarget.showSkyStarsControls = GUILayout.Toggle(myTarget.showSkyStarsControls,
                    "Stars and Galaxy Controls", headerFoldout);
