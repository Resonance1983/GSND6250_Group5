...
namespace Enviro
{
    ...
    public class EnviroQualityModuleEditor : EnviroModuleEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EnviroManager.instance.RemoveModule(EnviroManagerBase.ModuleType.Quality);
            ...
            if (myTarget.showModuleInspector)
            {
                ...
                if (commandName == "ObjectSelectorClosed" && EditorGUIUtility.GetObjectPickerControlID() == controlID)
                {
                    ...
                    for (var i = 0; i < myTarget.Settings.Qualities.Count; i++)
                ...
                if (GUILayout.Button("Create New")) myTarget.CreateNewQuality();

                myTarget.CleanupQualityList();

                for (var i = 0; i < myTarget.Settings.Qualities.Count; i++)
                {
                    var q = myTarget.Settings.Qualities[i];
                    ...
                    if (q != myTarget.Settings.defaultQuality)
                        if (GUILayout.Button("Set Default", EditorStyles.miniButtonRight, GUILayout.Width(75),
                                GUILayout.Height(18)))
                        {
                    ...
                    if (q.showEditor)
                    {
                        ...
                        var quality = myTarget.Settings.Qualities[i];
                        ...
                        if (q.showVolumeClouds)
                        {
                            ...
                            quality.volumetricCloudsOverride.volumetricClouds =
                                EditorGUILayout.Toggle("Volumetric Clouds",
                                    quality.volumetricCloudsOverride.volumetricClouds);
                            quality.volumetricCloudsOverride.dualLayer = EditorGUILayout.Toggle("Dual Layer",
                                quality.volumetricCloudsOverride.dualLayer);
                            GUILayout.Space(5);
                            quality.volumetricCloudsOverride.downsampling = EditorGUILayout.IntSlider("Downsampling",
                                quality.volumetricCloudsOverride.downsampling, 1, 6);
                            quality.volumetricCloudsOverride.stepsLayer1 = EditorGUILayout.IntSlider("Steps Layer 1",
                                quality.volumetricCloudsOverride.stepsLayer1, 32, 256);
                            quality.volumetricCloudsOverride.stepsLayer2 = EditorGUILayout.IntSlider("Steps Layer 2",
                                quality.volumetricCloudsOverride.stepsLayer2, 32, 256);
                            GUILayout.Space(5);
                            quality.volumetricCloudsOverride.blueNoiseIntensity = EditorGUILayout.Slider(
                                "Blue Noise Intensity", quality.volumetricCloudsOverride.blueNoiseIntensity, 0f, 2f);
                            quality.volumetricCloudsOverride.reprojectionBlendTime = EditorGUILayout.Slider(
                                "Reprojection Blending", quality.volumetricCloudsOverride.reprojectionBlendTime, 0f,
                                10f);
                            quality.volumetricCloudsOverride.lodDistance = EditorGUILayout.Slider("LOD",
                                quality.volumetricCloudsOverride.lodDistance, 0f, 1f);
                        }
                        ...
                        if (q.showFog)
                        {
                            ...
                            quality.fogOverride.volumetrics =
                                EditorGUILayout.Toggle("Volumetrics", quality.fogOverride.volumetrics);
#if !ENVIRO_HDRP
                            quality.fogOverride.unityFog =
                                EditorGUILayout.Toggle("Unity Fog", quality.fogOverride.unityFog);
#endif
                            quality.fogOverride.quality =
                                (EnviroFogSettings.Quality)EditorGUILayout.EnumPopup("Quality",
                                    quality.fogOverride.quality);
                            quality.fogOverride.steps =
                                EditorGUILayout.IntSlider("Steps", quality.fogOverride.steps, 16, 96);
                        }
                        ...
                        if (q.showFlatClouds)
                        {
                            ...
                            quality.flatCloudsOverride.flatClouds =
                                EditorGUILayout.Toggle("Flat Clouds", quality.flatCloudsOverride.flatClouds);
                            quality.flatCloudsOverride.cirrusClouds = EditorGUILayout.Toggle("Cirrus Clouds",
                                quality.flatCloudsOverride.cirrusClouds);
                        }
                        ...
                        if (q.showAurora)
                        {
                            ...
                            quality.auroraOverride.aurora =
                                EditorGUILayout.Toggle("Aurora", quality.auroraOverride.aurora);
                            quality.auroraOverride.steps =
                                EditorGUILayout.IntSlider("Steps", quality.auroraOverride.steps, 6, 32);
                        }
