...
namespace Enviro
{
    ...
    public class EnviroCloudsModuleEditor : EnviroModuleEditor
    {
        ...
        private SerializedProperty dualLayer,
            customWeatherMap,
            depthBlending,
            depthTest,
            ...
            cloudsWorldScale,
            maxRenderDistance,
            atmosphereColorSaturateDistance,
            cloudsTravelSpeed;

        //Properties Layer 1
        private SerializedProperty bottomCloudsHeightLayer1,
            topCloudsHeightLayer1,
            densityLayer1,
            densitySmoothnessLayer1,
            coverageLayer1,
            worleyFreq1Layer1,
            worleyFreq2Layer1,
            dilateCoverageLayer1,
            dilateTypeLayer1,
            cloudsTypeModifierLayer1,
            locationOffsetLayer1,
            scatteringIntensityLayer1,
            silverLiningSpreadLayer1,
            powderIntensityLayer1,
            curlIntensityLayer1,
            lightStepModifierLayer1,
            lightAbsorbtionLayer1,
            baseNoiseUVLayer1,
            detailNoiseUVLayer1,
            baseErosionIntensityLayer1,
            detailErosionIntensityLayer1,
            multiScatteringALayer1,
            multiScatteringBLayer1,
            multiScatteringCLayer1,
            anvilBiasLayer1;

        //Properties Layer 2
        private SerializedProperty bottomCloudsHeightLayer2,
            topCloudsHeightLayer2,
            densityLayer2,
            densitySmoothnessLayer2,
            coverageLayer2,
            worleyFreq1Layer2,
            worleyFreq2Layer2,
            dilateCoverageLayer2,
            dilateTypeLayer2,
            cloudsTypeModifierLayer2,
            locationOffsetLayer2,
            scatteringIntensityLayer2,
            silverLiningSpreadLayer2,
            powderIntensityLayer2,
            curlIntensityLayer2,
            lightStepModifierLayer2,
            lightAbsorbtionLayer2,
            baseNoiseUVLayer2,
            detailNoiseUVLayer2,
            baseErosionIntensityLayer2,
            detailErosionIntensityLayer2,
            multiScatteringALayer2,
            multiScatteringBLayer2,
            multiScatteringCLayer2,
            anvilBiasLayer2;

        //Properties Quality
        private SerializedProperty volumetricClouds,
            downsampling,
            stepsLayer1,
            stepsLayer2,
            blueNoiseIntensity,
            reprojectionBlendTime,
            lodDistance;

        private SerializedProperty windSpeedModifierLayer1,
            windUpwardsLayer1,
            cloudsWindDirectionXModifierLayer1,
            cloudsWindDirectionYModifierLayer1;

        private SerializedProperty windSpeedModifierLayer2,
            windUpwardsLayer2,
            cloudsWindDirectionXModifierLayer2,
            cloudsWindDirectionYModifierLayer2;
        ...
        public override void OnEnable()
        {
            ...
            atmosphereColorSaturateDistance =
                serializedObj.FindProperty("settingsGlobal.atmosphereColorSaturateDistance");
            ...
            cloudsWindDirectionYModifierLayer1 =
                serializedObj.FindProperty("settingsLayer1.cloudsWindDirectionYModifier");
            ...
            cloudsWindDirectionXModifierLayer2 =
                serializedObj.FindProperty("settingsLayer2.cloudsWindDirectionXModifier");
            cloudsWindDirectionYModifierLayer2 =
                serializedObj.FindProperty("settingsLayer2.cloudsWindDirectionYModifier");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            myTarget.showModuleInspector =
                GUILayout.Toggle(myTarget.showModuleInspector, "Volumetric Clouds", headerFoldout);


            GUILayout.FlexibleSpace();
            if (GUILayout.Button("x", EditorStyles.miniButtonRight, GUILayout.Width(18), GUILayout.Height(18)))
            {
                EnviroManager.instance.RemoveModule(EnviroManagerBase.ModuleType.VolumetricClouds);
            ...
            if (myTarget.showModuleInspector)
            {
                ...
                GUILayout.BeginVertical("", boxStyleModified);
                GUI.backgroundColor = Color.white;
                myTarget.showGlobalControls =
                    GUILayout.Toggle(myTarget.showGlobalControls, "Global Settings", headerFoldout);
                ...
                GUILayout.BeginVertical("", boxStyleModified);
                GUI.backgroundColor = Color.white;
                myTarget.showLayer1Controls =
                    GUILayout.Toggle(myTarget.showLayer1Controls, "Settings: Layer 1", headerFoldout);
                if (myTarget.showLayer1Controls)
                {
                    //Coverage
                    GUILayout.BeginVertical("", boxStyleModified);
                    myTarget.showCoverageControls =
                        GUILayout.Toggle(myTarget.showCoverageControls, "Coverage", headerFoldout);
                    ...
                    //Lighting
                    GUILayout.BeginVertical("", boxStyleModified);
                    myTarget.showLightingControls =
                        GUILayout.Toggle(myTarget.showLightingControls, "Lighting", headerFoldout);
                    ...
                    //Density
                    GUILayout.BeginVertical("", boxStyleModified);
                    myTarget.showDensityControls =
                        GUILayout.Toggle(myTarget.showDensityControls, "Density", headerFoldout);
                ...
                if (myTarget.settingsGlobal.dualLayer)
                {
                    ...
                    GUILayout.BeginVertical("", boxStyleModified);
                    GUI.backgroundColor = Color.white;
                    myTarget.showLayer2Controls =
                        GUILayout.Toggle(myTarget.showLayer2Controls, "Settings: Layer 2", headerFoldout);
