...
public class EnviroExternalWindow : EditorWindow
{
    ...
    public static void ShowWindow()
    {
        ...
        GetWindow(typeof(EnviroExternalWindow));
    }
    ...
    private void OnGUI()
    {
        ...
        {
            GUILayout.Label("Enviro 3 not in Scene. Please use this window in a Scene with Enviro 3.",
        ...
        scrollPosition =
            GUILayout.BeginScrollView(scrollPosition, false, false, GUILayout.Width(400), GUILayout.Height(600));
        ...
        if (Enviro.EnviroManager.instance.VolumetricClouds != null)
        {
            if (currentVolumetricCloudModuleEditor == null)
                currentVolumetricCloudModuleEditor =
                    Editor.CreateEditor(Enviro.EnviroManager.instance.VolumetricClouds);
