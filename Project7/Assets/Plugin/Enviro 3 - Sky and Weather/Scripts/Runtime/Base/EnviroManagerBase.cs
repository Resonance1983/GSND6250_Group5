...
namespace Enviro
{
    ...
    public class EnviroManagerBase : MonoBehaviour
    {
        ...
        [SerializeField] private EnviroConfiguration lastConfiguration;
        ...
        {
            if (Time != null) Time = Instantiate(Time);

            if (Sky != null) Sky = Instantiate(Sky);

            if (Lighting != null) Lighting = Instantiate(Lighting);

            if (Reflections != null) Reflections = Instantiate(Reflections);

            if (Fog != null) Fog = Instantiate(Fog);

            if (VolumetricClouds != null) VolumetricClouds = Instantiate(VolumetricClouds);

            if (FlatClouds != null) FlatClouds = Instantiate(FlatClouds);

            if (Weather != null) Weather = Instantiate(Weather);

            if (Aurora != null) Aurora = Instantiate(Aurora);

            if (Environment != null) Environment = Instantiate(Environment);

            if (Audio != null) Audio = Instantiate(Audio);

            if (Effects != null) Effects = Instantiate(Effects);

            if (Lightning != null) Lightning = Instantiate(Lightning);

            if (Quality != null) Quality = Instantiate(Quality);
        }
            ...
            switch (type)
            {
                ...
                case ModuleType.Lighting:
                    ...
                    else
                    {
                        ...
                        Lighting.preset =
                            (EnviroLightingModule)EnviroHelper.GetDefaultPreset("Default Lighting Preset");
                        Lighting.LoadModuleValues();
                        Lighting.Enable();
                ...
                case ModuleType.Reflections:
                    ...
                    else
                    {
                        ...
                        Reflections.preset =
                            (EnviroReflectionsModule)EnviroHelper.GetDefaultPreset("Default Reflections Preset");
                        Reflections.LoadModuleValues();
                        Reflections.Enable();
                ...
                case ModuleType.VolumetricClouds:
                    ...
                    else
                    {
                        ...
                        VolumetricClouds.preset =
                            (EnviroVolumetricCloudsModule)EnviroHelper.GetDefaultPreset(
                                "Default Volumetric Clouds Preset");
                        VolumetricClouds.LoadModuleValues();
                        VolumetricClouds.Enable();
                ...
                case ModuleType.FlatClouds:
                    ...
                    else
                    {
                        ...
                        FlatClouds.preset =
                            (EnviroFlatCloudsModule)EnviroHelper.GetDefaultPreset("Default Flat Clouds Preset");
                        FlatClouds.LoadModuleValues();
                        FlatClouds.Enable();
                ...
                case ModuleType.Environment:
                    ...
                    else
                    {
                        ...
                        Environment.preset =
                            (EnviroEnvironmentModule)EnviroHelper.GetDefaultPreset("Default Environment Preset");
                        Environment.LoadModuleValues();
                        Environment.Enable();
                ...
                case ModuleType.Lightning:
                    ...
                    else
                    {
                        ...
                        Lightning.preset =
                            (EnviroLightningModule)EnviroHelper.GetDefaultPreset("Default Lightning Preset");
                        Lightning.LoadModuleValues();
                        Lightning.Enable();
                ...
                case ModuleType.Quality:
                    ...
                    else
                    {
                        ...
                        Quality.preset =
                            (EnviroQualityModule)EnviroHelper.GetDefaultPreset("Default Quality Module Preset");
                        Quality.LoadModuleValues();
                        Quality.Enable();
