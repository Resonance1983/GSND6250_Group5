...
namespace Enviro
{
    ...
    public class EnviroReflections
    {
        ...
        [Tooltip(
            "Set if enviro reflection probe should use custom rendering setup. For example to include post effectsin birp.")]
        ...
        public ReflectionProbeTimeSlicingMode globalReflectionTimeSlicingMode =
        ...
        [Tooltip("Reflection probe intensity.")] [Range(0f, 2f)]
        ...
        [Tooltip(
            "Reflection probe scale. Increase that one to increase the area where reflection probe will influence your scene.")]
        [Range(10f, 10000f)]
        ...
        [Tooltip(
            "Enable this option to update the default reflection with global reflection probes cubemap. This can be needed for material that might not support direct reflection probes. (Instanced Indirect Rendering)")]
    ...
    public class EnviroReflectionsModule : EnviroModule
    {
        ...
        private void Setup()
        {
            if (EnviroManager.instance.Objects.globalReflectionProbe == null)
            {
                var newReflectionProbe = new GameObject();
                ...
                EnviroManager.instance.Objects.globalReflectionProbe =
                    newReflectionProbe.AddComponent<EnviroReflectionProbe>();
            }
        }
        ...
        private void UpdateReflection()
        {
            ...
            var probe = EnviroManager.instance.Objects.globalReflectionProbe;

            SetupProbeSettings(probe);

            if (EnviroManager.instance.Time != null)
                if ((lastReflectionUpdate < EnviroManager.instance.Time.Settings.timeOfDay || lastReflectionUpdate >
                        EnviroManager.instance.Time.Settings.timeOfDay +
                        (Settings.globalReflectionsTimeTreshold + 0.01f)) && Settings.globalReflectionsUpdateOnGameTime)
                {
                    RenderGlobalReflectionProbe(false, Settings.customRenderingTimeSlicing);
                    lastReflectionUpdate = EnviroManager.instance.Time.Settings.timeOfDay +
                                           Settings.globalReflectionsTimeTreshold;
                }

            if ((probe.transform.position.magnitude >
                 lastReflectionUpdatePos.magnitude + Settings.globalReflectionsPositionTreshold ||
                 probe.transform.position.magnitude <
                 lastReflectionUpdatePos.magnitude - Settings.globalReflectionsPositionTreshold) &&
        ...
        public void RenderGlobalReflectionProbe(bool forced = false, bool timeslice = false)
        {
            ...
            renderReflectionCoroutine =
                EnviroManager.instance.StartCoroutine(RenderGlobalReflectionProbeTimed(probe, timeslice));
            ...
            if (Settings.updateDefaultEnvironmentReflections)
            {
                ...
                // We don't need to copy the texture to a cubemap anmyore
                    ...
                    if(Settings.customRendering)
                     copyDefaultReflectionCoroutine =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 EnviroManager.instance.StartCoroutine(CopyDefaultReflectionCustom(probe, timeslice));
                    else
        ...
        private void CopyDefaultReflectionCubemap(EnviroReflectionProbe probe)
        {
            if (Settings.defaultSkyReflectionTex == null ||
                Settings.defaultSkyReflectionTex.height != probe.myProbe.texture.height ||
                Settings.defaultSkyReflectionTex.width != probe.myProbe.texture.width)
            {
                if (Settings.defaultSkyReflectionTex != null)
                    DestroyImmediate(Settings.defaultSkyReflectionTex);

                Settings.defaultSkyReflectionTex = new Cubemap(probe.myProbe.resolution,
                    probe.myProbe.hdr ? TextureFormat.RGBAHalf : TextureFormat.RGBA32, true);
        ...
        public void UpdateDefaultReflectionTextureMode()
        {
            if (Settings.updateDefaultEnvironmentReflections && Settings.globalReflections)
            {
                ...
                RenderSettings.customReflectionTexture =
                    EnviroManager.instance.Objects.globalReflectionProbe.myProbe.texture;
#else
                if(Settings.defaultSkyReflectionTex != null)
        ...
        private void SetupProbeSettings(EnviroReflectionProbe probe)
        {
            ...
            probe.myProbe.size = new Vector3(Settings.globalReflectionsScale, Settings.globalReflectionsScale,
                Settings.globalReflectionsScale);
            ...
            if(probe.hdprobe != null)
            {
                ...
                probe.hdprobe.settingsRaw.influence.boxSize =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            new Vector3 (Settings.globalReflectionsScale,Settings.globalReflectionsScale,Settings.globalReflectionsScale);
        ...
        {
#if UNITY_EDITOR
            var t = CreateInstance<EnviroReflectionsModule>();
            t.name = "Reflections Module";
            t.Settings = JsonUtility.FromJson<EnviroReflections>(JsonUtility.ToJson(Settings));
