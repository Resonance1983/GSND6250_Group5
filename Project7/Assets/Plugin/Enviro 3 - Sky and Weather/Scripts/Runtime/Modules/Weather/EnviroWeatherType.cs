...
namespace Enviro
{
    ...
    {
        public List<EnviroAudioOverrideType> ambientOverride = new();
        public List<EnviroAudioOverrideType> weatherOverride = new();
    }
    ...
    {
        public List<EnviroEffectsOverrideType> effectsOverride = new();
    }
    ...
    public class EnviroWeatherType : ScriptableObject
    {
        ...
        public bool showEditor,
            ...
            showAudioControls,
            showAmbientAudioControls,
            showWeatherAudioControls,
            showLightningControls;
    ...
    public class EnviroWeatherTypeCreation
    {
        ...
        {
            var wpreset = ScriptableObject.CreateInstance<EnviroWeatherType>();
#if UNITY_EDITOR
            ...
            if (path == "") path = EnviroHelper.assetPath + "/Profiles/Weather Types";
            var assetPathAndName =
                UnityEditor.AssetDatabase.GenerateUniqueAssetPath(path + "/New " + "Weather Type" + ".asset");
        ...
        public static GameObject GetAssetPrefab(string name)
        {
            ...
            for (var idx = 0; idx < assets.Length; idx++)
            {
                ...
                if (path.Contains(".prefab")) return UnityEditor.AssetDatabase.LoadAssetAtPath<GameObject>(path);
            }
#endif
            return null;
        }
        ...
        public static Cubemap GetAssetCubemap(string name)
        {
            ...
            {
                var path = UnityEditor.AssetDatabase.GUIDToAssetPath(assets[idx]);
                if (path.Contains(".png")) return UnityEditor.AssetDatabase.LoadAssetAtPath<Cubemap>(path);
            }
#endif
            return null;
        }
        ...
        public static Texture GetAssetTexture(string name)
        {
            ...
            {
                var path = UnityEditor.AssetDatabase.GUIDToAssetPath(assets[idx]);
                if (path.Length > 0) return UnityEditor.AssetDatabase.LoadAssetAtPath<Texture>(path);
            }
#endif
            return null;
        }
