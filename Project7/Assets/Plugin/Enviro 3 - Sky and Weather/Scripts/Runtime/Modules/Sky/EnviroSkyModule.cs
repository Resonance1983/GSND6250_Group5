...
namespace Enviro
{
    ...
    public class EnviroSky
    {
        ...
        //Front Colors
        [GradientUsage(true)] public Gradient frontColorGradient0,
            frontColorGradient1,
            frontColorGradient2,
            frontColorGradient3,
            frontColorGradient4,
        ...
        //Back Colors
        [GradientUsage(true)] public Gradient backColorGradient0,
            backColorGradient1,
            backColorGradient2,
            backColorGradient3,
            backColorGradient4,
        ...
        //Other Colors
        [GradientUsage(true)] public Gradient sunDiscColorGradient, moonColorGradient, moonGlowColorGradient;
        ...
        //Distribution  
        [Range(-0.1f, 1f)] public float distribution0, distribution1, distribution2, distribution3;
        ...
        [Range(0f, 1f)] public float starsTwinklingSpeed = 0.1f;
        [Range(-2f, 2f)] public float moonPhase;
        public AnimationCurve skyExposureHDRP;
#if ENVIRO_HDRP
        public UnityEngine.Rendering.HighDefinition.SkyAmbientMode skyAmbientModeHDRP =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             UnityEngine.Rendering.HighDefinition.SkyAmbientMode.Dynamic;
#endif
        [ColorUsage(false, true)] public Color skyColorTint = Color.white;
    }
    ...
    public class EnviroSkyModule : EnviroModule
    {
        ...
        public override void UpdateModule()
        {
            ...
            if (EnviroManager.instance != null && EnviroManager.instance.Time != null &&
                Settings.moonMode == EnviroSky.MoonMode.Realistic)
                UpdateMoonPhase();
        }
        ...
        {
            var solarTime = EnviroManager.instance.solarTime;
            ...
            if (Settings.moonMode == EnviroSky.MoonMode.Off)
                mat.SetVector("_SkyMoonParameters",
                    new Vector4(Settings.moonPhase, Settings.moonScale, Settings.moonScale, 0f));
            else
                mat.SetVector("_SkyMoonParameters",
                    new Vector4(Settings.moonPhase, Settings.moonScale, Settings.moonScale, 1f));

            mat.SetVector("_SkySunParameters",
                new Vector4(Settings.sunScale, Settings.sunScale, Settings.sunScale, Settings.sunScale));
            ...
            if (EnviroManager.instance.Aurora == null) Shader.SetGlobalFloat("_Aurora", 0f);
            ...
            if (Settings.starsTwinklingSpeed > 0.0f)
            {
                ...
                var rot = Quaternion.Euler(starsTwinkling, starsTwinkling, starsTwinkling);
                var NoiseRot = Matrix4x4.TRS(Vector3.zero, rot, new Vector3(1, 1, 1));
        ...
        {
            var angle = Vector3.SignedAngle(EnviroManager.instance.Objects.moon.transform.forward,
                EnviroManager.instance.Objects.sun.transform.forward, -EnviroManager.instance.transform.forward);
        ...
        public void UpdateHDRPSky ()
        {
            ...
            {           
                ...
                {  
                    ...
                    enviroHDRPSky.skyIntensityMode.value =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           UnityEngine.Rendering.HighDefinition.SkyIntensityMode.Exposure;
                    ...
                    if(Application.isPlaying)
                       enviroHDRPSky.updateMode.value =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                UnityEngine.Rendering.HighDefinition.EnvironmentUpdateMode.OnChanged;
                    else
                       enviroHDRPSky.updateMode.value =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       UnityEngine.Rendering.HighDefinition.EnvironmentUpdateMode.Realtime;
        ...
        {
#if UNITY_EDITOR
            var t = CreateInstance<EnviroSkyModule>();
            t.name = "Sky Module";
            t.Settings = JsonUtility.FromJson<EnviroSky>(JsonUtility.ToJson(Settings));
