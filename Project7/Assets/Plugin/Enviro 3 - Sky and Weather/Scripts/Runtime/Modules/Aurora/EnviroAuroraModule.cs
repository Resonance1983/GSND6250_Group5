...
namespace Enviro
{
    ...
    public class EnviroAurora
    {
        ...
        [Header("Aurora Intensity")] [Range(0f, 1f)]
        public float auroraIntensityModifier = 1f;

        public AnimationCurve auroraIntensity =
            new(new Keyframe(0f, 1f), new Keyframe(0.5f, 0.1f), new Keyframe(1f, 0f));

        // 
        [Header("Aurora Color and Brightness")]
        public Color auroraColor = new(0.1f, 0.5f, 0.7f);
        ...
        // 
        [Header("Aurora Height and Scale")] public float auroraHeight = 20000f;

        [Range(0f, 0.025f)] public float auroraScale = 0.01f;

        //
        [Header("Aurora Performance")] [Range(8, 32)]
        public int auroraSteps = 20;

        //
        [Header("Aurora Modelling and Animation")]
        public Vector4 auroraLayer1Settings = new(0.1f, 0.1f, 0f, 0.5f);

        public Vector4 auroraLayer2Settings = new(5f, 5f, 0f, 0.5f);
        public Vector4 auroraColorshiftSettings = new(0.05f, 0.05f, 0f, 5f);
        [Range(0f, 0.1f)] public float auroraSpeed = 0.005f;
        [Header("Aurora Textures")] public Texture2D aurora_layer_1;
    ...
    public class EnviroAuroraModule : EnviroModule
    {
        ...
        public override void UpdateModule()
        {
            ...
            if (EnviroManager.instance.Sky != null) UpdateAuroraShader();
        }
        ...
        public void UpdateAuroraShader()
        {
            ...
            Shader.SetGlobalFloat("_AuroraIntensity",
                Mathf.Clamp01(Settings.auroraIntensityModifier *
                              Settings.auroraIntensity.Evaluate(EnviroManager.instance.solarTime)));
        ...
        {
#if UNITY_EDITOR
            var t = CreateInstance<EnviroAuroraModule>();
            t.name = "Aurora Preset";
            t.Settings = JsonUtility.FromJson<EnviroAurora>(JsonUtility.ToJson(Settings));
