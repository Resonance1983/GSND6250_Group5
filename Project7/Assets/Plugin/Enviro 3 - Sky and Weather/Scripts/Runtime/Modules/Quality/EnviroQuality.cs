...
namespace Enviro
{
    ...
    public class EnviroAuroraQualitySettings
    {
        ...
        [Range(6, 32)] public int steps = 32;
    }
    ...
    public class EnviroFogQualitySettings
    {
        ...
        [Range(16, 96)] public int steps = 32;
    }
    ...
    public class EnviroQualityCreation
    {
        ...
        {
            var wpreset = ScriptableObject.CreateInstance<EnviroQuality>();
#if UNITY_EDITOR
            ...
            if (path == "") path = EnviroHelper.assetPath;
            var assetPathAndName =
                UnityEditor.AssetDatabase.GenerateUniqueAssetPath(path + "/New " + "Quality" + ".asset");
