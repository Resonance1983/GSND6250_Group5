...
namespace Enviro
{
    ...
    public class EnviroFogSettings
    {
        ...
        [Range(0f, 2f)] public float scattering;

        public AnimationCurve scatteringMultiplier = new(new Keyframe(0, 1), new Keyframe(1, 1));
        [Range(0f, 1f)] public float extinction;
        [Range(0f, 1f)] public float anistropy;
        public float maxRange = 1000f;
        public float maxRangePointSpot = 100f;

        [Range(0f, 1f)] public float noiseIntensity;
        [Range(0f, 0.01f)] public float noiseScale;
        ...
        public float
            fogDensity =
                0.02f; // This is the global density factor, which can be thought of as the fog layer's thickness.

        [Range(0.001f, 0.1f)]
        public float
            fogHeightFalloff =
                0.2f; // Height density factor, controls how the density increases as height decreases. Smaller values make the transition larger.

        public float fogHeight = 0.0f;
        [Range(0.0f, 1f)] public float fogDensity2 = 0.02f;
        [Range(0.001f, 0.1f)] public float fogHeightFalloff2 = 0.2f;
        public float fogHeight2;
        [Range(0.0f, 1.0f)] public float fogMaxOpacity = 1.0f;
        [Range(0.01f, 5000.0f)] public float startDistance = 0.0f;
        [Range(0.0f, 1.0f)] public float fogColorBlend = 0.5f;
        public Color fogColorMod = Color.white;

        [GradientUsage(true)] public Gradient ambientColorGradient;
        ...
        */
        ...
        [GradientUsage(true)] public Gradient unityFogColor = new();
    }
    ...
    public class EnviroFogModule : EnviroModule
    {
        ...
        public List<EnviroVolumetricFogLight> fogLights = new();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        public override void Enable()
        {
            ...
            if (EnviroManager.instance.Objects.directionalLight != null)
                if (EnviroManager.instance.Objects.directionalLight.gameObject
                        .GetComponent<EnviroVolumetricFogLight>() == null)
                    directionaLight = EnviroManager.instance.Objects.directionalLight.gameObject
                        .AddComponent<EnviroVolumetricFogLight>();

            if (EnviroManager.instance.Objects.additionalDirectionalLight != null)
                if (EnviroManager.instance.Objects.additionalDirectionalLight.gameObject
                        .GetComponent<EnviroVolumetricFogLight>() == null)
                    additionalLight = EnviroManager.instance.Objects.additionalDirectionalLight.gameObject
                        .AddComponent<EnviroVolumetricFogLight>();
#endif
        }
            ...
            if (EnviroManager.instance.Objects.directionalLight != null)
                if (EnviroManager.instance.Objects.directionalLight.gameObject
                    ...
                    DestroyImmediate(EnviroManager.instance.Objects.directionalLight.gameObject
                        .GetComponent<EnviroVolumetricFogLight>());
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            { 
                ...
                { 
                    ...
                    if(Settings.controlHDRPVolumetrics)
                    {
                        ...
                        {
                            EnviroManager.instance.Lighting.directionalLightHDRP.volumetricDimmer =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  Settings.directLightMultiplier;
                            EnviroManager.instance.Lighting.directionalLightHDRP.volumetricShadowDimmer =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            Settings.directLightShadowdimmer;
                        }
                        if(EnviroManager.instance.Lighting != null && EnviroManager.instance.Lighting.additionalLightHDRP != null)
                        { 
                            EnviroManager.instance.Lighting.additionalLightHDRP.volumetricDimmer =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         Settings.directLightMultiplier;
                            EnviroManager.instance.Lighting.additionalLightHDRP.volumetricShadowDimmer =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  Settings.directLightShadowdimmer;
                        }
                    }
                    else
        ...
        private void UpdateUnityFog()
        {
            ...
            RenderSettings.fogColor = Settings.unityFogColor.Evaluate(EnviroManager.instance.solarTime) *
                                      (Settings.fogColorMod * EnviroManager.instance.solarTime);
        }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        {
            Shader.SetGlobalVector("_EnviroFogParameters",
                new Vector4(0f, Settings.fogHeightFalloff, Settings.fogDensity * 0.01f,
                    Settings.fogHeight + Settings.globalFogHeight));
            Shader.SetGlobalVector("_EnviroFogParameters2",
                new Vector4(0f, Settings.fogHeightFalloff2, Settings.fogDensity2 * 0.01f,
                    Settings.fogHeight2 + Settings.globalFogHeight));
            Shader.SetGlobalVector("_EnviroFogParameters3",
                new Vector4(1.0f - Settings.fogMaxOpacity, Settings.startDistance, 0f, Settings.fogColorBlend));
            Shader.SetGlobalColor("_EnviroFogColor",
                Settings.ambientColorGradient.Evaluate(EnviroManager.instance.solarTime) *
                (Settings.fogColorMod * EnviroManager.instance.solarTime));
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        public void RenderVolumetrics(Camera camera, RenderTexture source)
        {
            ...
            else if (Settings.quality == EnviroFogSettings.Quality.Medium)
            {
                ...
                var target = RenderTexture.GetTemporary(desc);
                var depth = RenderTexture.GetTemporary(desc);
            ...
            else if (Settings.quality == EnviroFogSettings.Quality.Low)
            {
                desc.width = source.width / 2;
                desc.height = source.height / 2;
                var depthHalf = RenderTexture.GetTemporary(desc);
                depthHalf.filterMode = FilterMode.Point;
                desc.width = source.width / 4;
                desc.height = source.height / 4;
                var target = RenderTexture.GetTemporary(desc);
                var depthQuarter = RenderTexture.GetTemporary(desc);
        ...
        { 
            ...
            RenderTextureDescriptor renderTextureDescriptor =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 new RenderTextureDescriptor(desc.width,desc.height,RenderTextureFormat.ARGBHalf,0);
        ...
        else if (Settings.quality == EnviroFogSettings.Quality.Low)
        {
            ...
            UnityEngine.Rendering.RenderGraphModule.TextureHandle depthQuarter =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               renderGraph.CreateTexture(depthQuarterdesc);
        ...
        private void UpdateVolumetricsShader(Material mat)
        {
            ...
            {
                mat.SetVector("_DirLightDir",
                    new Vector4(myLight.transform.forward.x, myLight.transform.forward.y, myLight.transform.forward.z,
                        1.0f / (myLight.range * myLight.range)));
            ...
            mat.SetVector("_WindDirection",
                new Vector4(Settings.windDirection.x, Settings.windDirection.y, Settings.windDirection.z));
            mat.SetVector("_NoiseData", new Vector4(Settings.noiseScale, Settings.noiseIntensity));
            mat.SetVector("_MieG",
                new Vector4(Settings.anistropy, 1 + Settings.anistropy * Settings.anistropy, 2 * Settings.anistropy,
                    1.0f / (4.0f * Mathf.PI)));
            mat.SetVector("_VolumetricLight",
                new Vector4(
                    Settings.scattering * Settings.scatteringMultiplier.Evaluate(EnviroManager.instance.solarTime),
                    Settings.extinction, 1f, 0f)); // - SkyboxExtinctionCoef));

            mat.SetTexture("_NoiseTexture", Settings.noise);
            mat.SetTexture("_DitherTexture", Settings.ditheringTex);

            mat.SetVector("_Randomness",
                new Vector4(UnityEngine.Random.value, UnityEngine.Random.value, UnityEngine.Random.value,
        ...
        private void CreateVolumetricsBuffers()
        {
            ...
            for (var i = 0; i < fogLights.Count; i++)
            {
                var fogLight = fogLights[i];

                if (fogLight == null)
                    continue;

                var isOn = fogLight.isOn;

                switch (fogLight.light.type)
                {
                    case LightType.Point:
                        if (isOn) pointLightCount++;
                        break;
                    case LightType.Spot:
                        if (isOn) spotLightCount++;
                        break;
                }
            }

            EnviroHelper.CreateBuffer(ref m_PointLightParamsCB, pointLightCount,
                Marshal.SizeOf(typeof(PointLightParams)));
        ...
        {
            var count = m_PointLightParamsCB == null ? 0 : m_PointLightParamsCB.count;
            ...
            for (var i = 0; i < fogLights.Count; i++)
            {
                ...
                var range = light.range * fl.range;
                m_PointLightParams[lightID].range = 1.0f / (range * range);
                m_PointLightParams[lightID].color = new Vector3(light.color.r, light.color.g, light.color.b) *
        ...
        {
            var count = m_SpotLightParamsCB == null ? 0 : m_SpotLightParamsCB.count;
            ...
            for (var i = 0; i < fogLights.Count; i++)
            {
                ...
                m_SpotLightParams[lightID].color = new Vector3(light.color.r, light.color.g, light.color.b) *
                                                   light.intensity * fl.intensity;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        {
#if UNITY_EDITOR
            var t = CreateInstance<EnviroFogModule>();
            t.name = "Fog Module";
            t.Settings = JsonUtility.FromJson<EnviroFogSettings>(JsonUtility.ToJson(Settings));
